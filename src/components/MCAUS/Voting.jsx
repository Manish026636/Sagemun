  ...
  return (
    <div className="mt-10 p-2 container mx-auto">
          ...
          <table className="text-center  table-auto w-full ">
            <thead className="sticky top-0 bg-gray-200 text-gray-800">
              <tr>
                ...
                <th colspan="3" className="px-2 py-2">Vote</th>
      ...
      <div className="flex justify-center mt-8">
        {isVotePassed() ? (
          <div className="bg-green-500 lg:w-1/2 text-white px-6 py-3 rounded-xl text-center">
          ...
          <div className="bg-red-500 w-full lg:w-1/2 text-white px-6 py-3 rounded-xl text-center">
